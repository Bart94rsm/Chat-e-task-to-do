config = {
  ...
  oraAttuale: new Date().toLocaleTimeString([], {
    hour: "numeric",
    minute: "numeric",
  }),
...
function completaTask() {
  const checked = (e) => {
    ...
    if (taskSimbol) {
      ...
      if (taskText) {
        //attendo che html carichi nuovo div creato dinamicamente da inserimentoTask, fino a che non esiste non applica lo stile
